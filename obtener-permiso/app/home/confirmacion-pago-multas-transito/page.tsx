...
export default function ConfirmacionPagoMultasTransitoPage() {
  ...
  // Llamada a endpoint para eliminar multas de tránsito pagadas
  useEffect(() => {
    if (resultadoPago === "exitoso" && rut_propietario && ppu) {
      const eliminarMultas = async () => {
        try {
          const url = `${API_CONFIG.SRCEI}delete_multas_transito/?ppu=${encodeURIComponent(ppu)}`;
          ...
          if (!response.ok) {
            throw new Error('Error al eliminar multas');
          }

          const data = await response.json();
          console.log('Multas eliminadas:', data);
        } catch (error) {
          ...
          <div className="col-lg-6 col-md-8 col-sm-10">
            <div className="card-like border-0 shadow">
              <div className="card-body text-center p-5">
                ...
                >
                  {resultadoPago === "exitoso"
                    ? "El pago de tus multas de tránsito ha sido procesado correctamente."
